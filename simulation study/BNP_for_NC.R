...
# General functions for matrix of weights to call in the Gibbs
...
# General functions for matrix of weights to call in the DERF posterior function
...
# curve estimating expected CERF
causal_effect_median<- function(data_sim,post_chian,split_function_x){
  
  # min and max of the values for the treatment x
  ...
  for(i in 1:sample){
    ...
    # smoothing the obtained curve
    points_y_smooth_02[i,]=ksmooth(points_x_i, points_y_samples[i,], 
                                   "normal", bandwidth = 0.2)$y
  }
